<template>
  <section class="Home pt-4 sm:pt-6">
    <Alert class="pt-0 pb-2 sm:py-4">
      <AlertTitle class="font-bold hidden sm:flex sm:gap-2"> <RocketIcon class="h-4 w-4 hidden sm:flex" /> NPDP!</AlertTitle>
      <AlertDescription class="p-0 text-xs sm:text-sm">
        ...
        <p style="font-weight: bold">由月见网支持: <a class="text-[#0969da]" href="https://bbs.mostmind.top/" target="_blank">Link</a></p>
      </AlertDescription>
    </Alert>
